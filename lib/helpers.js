...
module.exports = {
  ...
  getAppSettings: function(){
    ...
    /*
     * Attempt to load a themes favicon, load default if it doesn't exist.
     */
    var faviconPath = path.join(themeDir, 'public', 'favicon.ico')
    try{
      fs.statSync(faviconPath)
    }
    catch (e){
      faviconPath = path.join(defaultPath, 'themes', 'littoral-demo-theme', 'public', 'favicon.ico')
    }
  ...
  sharedMiddleware: function(app){
    app.use(function(req, res, next){
      res.set('x-powered-by', 'Littoral');
      next();
    });
